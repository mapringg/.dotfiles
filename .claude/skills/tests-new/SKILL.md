---
name: tests-new
description: Identifies and adds missing tests for recent code changes. Use when asked to add tests for recent work or improve test coverage for new features.
---
