---
name: deepstack
description: Generates a comprehensive deep research prompt tailored to the current project's technology stack. Use when asked to research security, performance, testing, or other technical topics for the stack.
argument-hint: technical topic to research
---
