---
name: interview
description: Refine a vague idea into a concrete spec through structured interviewing. Use when the user has a half-baked idea and wants to turn it into a product or technical spec.
---
...
## Phase 3: Interview iteratively

Ask the user 1-2 questions at a time. Tailor your questions to the mode:
