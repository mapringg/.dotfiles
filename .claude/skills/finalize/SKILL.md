---
name: finalize
description: Clean up false starts, dead-end approaches, and experimental code from recent work. Use when done with a feature and want to consolidate into a clean implementation before committing.
---

# Finalize for Recent Work
