---
name: finalize
description: Cleans up completed feature work by removing false starts, dead-end approaches, and experimental code. Use when asked to finalize, clean up, or consolidate recent work.
---
