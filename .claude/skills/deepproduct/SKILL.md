---
name: deepproduct
description: Generates a comprehensive deep research prompt for product design questions tailored to the current project. Use when asked to research UX patterns, product design, or user experience topics.
argument-hint: product question or topic to research
---
