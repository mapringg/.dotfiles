---
name: new-tests
description: Review recent work and write missing tests for new or changed behavior. Use when asked to add tests, check test coverage, or write tests for recent changes.
---
