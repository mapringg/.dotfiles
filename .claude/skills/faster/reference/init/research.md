...
Determine the init names from context or by asking the user. For each name:

1. Verify `~/.claude/skills/faster/reference/init/helpers/init-{name}.md` exists
...
1. **Read the current init file** at `~/.claude/skills/faster/reference/init/helpers/init-{name}.md`
