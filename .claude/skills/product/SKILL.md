---
name: product
description: Generate a deep research prompt tailored to the project's product context. Use when asked to research UX patterns, design best practices, or product decisions.
---
...
AFTER displaying the profile above, ask the user a simple confirmation question:
...
I need comprehensive research on **[TOPIC]** — specifically product design best practices, UX patterns, and real-world examples for a product like mine.
