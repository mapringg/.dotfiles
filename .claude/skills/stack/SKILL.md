---
name: stack
description: Generate a deep research prompt tailored to the project's technology stack. Use when asked to research security, performance, testing, or other technical best practices for the current stack.
---
...
AFTER displaying the stack details above, ask the user a simple confirmation question:
...
I need comprehensive research on **[TOPIC]** best practices, patterns, and considerations for this specific stack.
